      ...
      <main className={styles.content}>
        ...
        <FadeItem><section id="solution" data-section="Solution" ref={reg('Solution')} className={styles.section}>
          ...
          <div className={styles.sectionBody}>
            ...
            <ImgBlock src="/assets/luotain/homepage.mov" />
            ...
            <ImgBlock src="/assets/luotain/create-screen.mov" />
        ...
        <FadeItem><section id="features" data-section="Features" ref={reg('Features')} className={styles.section}>
          ...
          <div className={styles.sectionBody}>
            ...
            <ImgBlock src="/assets/luotain/qr-designer.mov" />
            ...
            <ImgBlock src="/assets/luotain/qr-tilt.mov" />
            ...
            <ImgBlock src="/assets/luotain/compare-links.mov" />
            ...
            <ImgBlock src="/assets/luotain/invite-members.mov" />
            ...
            <ImgBlock src="/assets/luotain/add-domain.mov" />
