  ...
  return (
    <nav className={styles.nav}>
      ...
      <div className={styles.links}>
        ...
        <a href="https://x.com/shatertsavsar" target="_blank" rel="noopener">X</a>
        <a href="https://linkedin.com/in/shatertsavsar" target="_blank" rel="noopener">LinkedIn</a>
        <a href="mailto:shater@example.com">Email</a>
      </div>
    </nav>
  )
}
